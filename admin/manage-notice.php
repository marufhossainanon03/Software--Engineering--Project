...
{               ?>   
                          <tr>
                            ...
                            <td>
                              <div><a href="edit-notice-detail.php?editid=<?php echo htmlentities ($row->nid);?>" class="btn btn-info btn-xs"  target="blank">Edit</a>
                                               <a href="manage-notice.php?delid=<?php echo ($row->nid);?>" onclick="return confirm('Do you really want to Delete ?');" class="btn btn-danger btn-xs"> Delete</a></div>
                            </td> 
