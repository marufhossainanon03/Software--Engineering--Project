        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title"> Between Dates Reports of Stduents</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Between Dates Reports of Stduents</li>
                </ol>
              </nav>
            </div>
            <div class="row">
...
?>
<h5 align="center" style="color:blue">Stduents Report from <?php echo $fdate?> to <?php echo $tdate?></h5>
                    </div>
