...
$sql="SELECT tblhomework.homeworkTitle,tblhomework.postingDate,tblhomework.lastDateofSubmission,tblhomework.classId from tblhomework join tblclass on tblclass.ID=tblhomework.classId  where tblhomework.id=:hwid";
$query = $dbh -> prepare($sql);
...
$classid=$row->classId;
 ?>
                    ...
                    <strong>Last Date of Submission:</strong> <?php echo htmlentities($row->lastDateofSubmission)?></p>
