...
?>
                          <span class="report-title">Total Semester</span>
                          <h4><?php echo htmlentities($totclass);?></h4>
                          <a href="manage-class.php"><span class="report-count"> View Semester</span></a>
                        </div>
...
?>
                          <span class="report-title">Course Notice</span>
...
?>
                          <span class="report-title">University Notice</span>
